...
- Small-project integration smoke must cover a real CLI child process from `E:\own_space\cocos_work_lab_38x`: `node dist/cli.js preview --runtime ...`.
...
```powershell
rtk git add docs/dev/runtime-preview-small-project-acceptance-20260607.md
