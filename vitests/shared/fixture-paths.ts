...
export interface RuntimePreviewCliIntegrationFixturePaths {
  projectRoot: string;
  engineRoot: string;
  editorLibraryRef?: string;
  editorProgrammingRef?: string;
...
export function getCliIntegrationFixturePaths(): RuntimePreviewCliIntegrationFixturePaths {
  return {
    projectRoot: requirePath('COCOS_CLI_TEST_PROJECT_ROOT'),
    engineRoot: requirePath('COCOS_CLI_TEST_ENGINE_ROOT'),
    editorLibraryRef: optionalPath('COCOS_CLI_TEST_EDITOR_LIBRARY_REF'),
    editorProgrammingRef: optionalPath('COCOS_CLI_TEST_EDITOR_PROGRAMMING_REF'),
  };
}
